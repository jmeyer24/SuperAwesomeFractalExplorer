export const MandelbulbFractallabFrag = `
...
#define aspectRatio outputSize.x / outputSize.y;
#define fovfactor 1.0 / sqrt(1.0 + cameraFocalLength * cameraFocalLength);
#define pixelScale 1.0 / min(outputSize.x, outputSize.y);
#define epsfactor 2.0 * fovfactor * pixelScale * surfaceDetail;
#define w vec3(0, 0, 1);
#define v vec3(0, 1, 0);
#define u vec3(1, 0, 0);
#define cameraRotation;


// Return rotation matrix for rotating around vector v by angle
mat3 rotationMatrixVector(in vec3 v, float angle)
{
